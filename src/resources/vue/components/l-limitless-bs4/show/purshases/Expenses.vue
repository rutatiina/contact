                ...
                <table class="table table-hover">
                    <thead>
                        <tr class="table-active">
                            ...
                            <th scope="col" class="font-weight-bold" nowrap="">Account Debited</th>
                            <th scope="col" class="font-weight-bold" nowrap="">Account Credited</th>
                            <th scope="col" class="font-weight-bold" nowrap="">Payment mode</th>
                    ...
                    <tbody>
                        <tr v-for="row in tableData.payload.data"
                            ...
                            <td class="cursor-pointer">{{row.debit_account.name}}</td>
                            <td class="cursor-pointer">{{row.credit_account.name}}</td>
                            <td class="cursor-pointer">{{row.payment_mode}}</td>
