...
Route::group(['middleware' => ['web', 'auth', 'tenant']], function() {
    ...
    Route::post('contacts/deactivate', 'Rutatiina\Contact\Http\Controllers\ContactController@deactivate')->name('contacts.deactivate');
    Route::post('contacts/delete', 'Rutatiina\Contact\Http\Controllers\ContactController@delete')->name('contacts.delete');
    Route::post('contacts/activate', 'Rutatiina\Contact\Http\Controllers\ContactController@activate')->name('contacts.activate');
